...
export function Home() {
  return (
    <>
      <div className='grid w-full grid-cols-1 items-center justify-items-center gap-6 bg-center bg-cover bg-image-patter px-3 py-8 sm:grid-cols-2 sm:px-6 lg:grid-cols-3'>
        ...
        <div className='rounded-md bg-slate-50/10 p-6 backdrop-blur-md'>
          ...
          <article className='text-center sm:px-10'>
            O Instituto São Gabriel se insere no campo educacional do país como
            um instrumento de transformação social, tendo com princípio
            fundamental o desenvolvimento humano integral de seus alunos.
          </article>
        </div>
      </div>
    </>
